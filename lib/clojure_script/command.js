...
clojure_script.command = {};
clojure_script.command.run = function() {
  return cljs.core.println.call(null, "Hello from command.js")
};
goog.exportSymbol("clojure_script.command.run", clojure_script.command.run);
cljs.nodejscli = {};
