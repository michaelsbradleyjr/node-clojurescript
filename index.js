...
;(function (undefined) {
  ...
  ClojureScript.localBuilder = function(options, cljscOptions, callback, javaOptions) {
    ...
    if (options.classpath) {
      ...
      ClojureScript.addClassPath(path.resolve(path.normalize(options.classpath + '/..')));
    }
